...
const DemoEventComponent: React.FC<MyProps> = (props: MyProps) => {
    ...
    const myEventFunction = (synthEvent: SyntheticEvent) => {
        ...
        /*
            SythenticEvent is a generic type of Event object that React gives you; you don't have to include the event parameter, but if you need
            metadata regarding then opting into the event object may be a good idea. If you need more specific metadata about the event then you
            may want to choose a more specific event datatype; there are lots of them, for example, MouseEent, KeyboardEvent, FormEvent, ChangeEvent, etc.
        */
